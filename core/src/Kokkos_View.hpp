...
namespace Kokkos {
namespace Impl {
template <ConstExprLabel, class ViewType, int Traits>
...
struct is_always_assignable_impl<Kokkos::View<LabelDst, ViewTDst...>,
  ...
  using dst_mdspan = typename Kokkos::View<LabelDst, ViewTDst...>::mdspan_type;
  using src_mdspan = typename Kokkos::View<LabelSrc, ViewTSrc...>::mdspan_type;
...
template <ConstExprLabel LabelDst, class... ViewTDst, ConstExprLabel LabelSrc,
          class... ViewTSrc>
constexpr bool is_assignable(const Kokkos::View<LabelDst, ViewTDst...>& dst,
                             const Kokkos::View<LabelSrc, ViewTSrc...>& src) {
  using dst_mdspan = typename Kokkos::View<LabelDst, ViewTDst...>::mdspan_type;
  using src_mdspan = typename Kokkos::View<LabelSrc, ViewTSrc...>::mdspan_type;

  return is_always_assignable_v<Kokkos::View<LabelDst, ViewTDst...>,
                                Kokkos::View<LabelSrc, ViewTSrc...> > ||
         (std::is_constructible_v<dst_mdspan, src_mdspan> &&
...
template <ConstExprLabel Label, class D, class... P>
struct is_view<View<Label, D, P...> > : public std::true_type {};

template <ConstExprLabel Label, class D, class... P>
struct is_view<const View<Label, D, P...> > : public std::true_type {};
...
class View : public Impl::BasicViewFromTraits<DataType, Properties...>::type {
 ...
 public:
  ...
  template <ConstExprLabel LabellOther, class OtherT, class... OtherArgs>
  //    requires(std::is_constructible_v<
  //             mdspan_type, typename View<OtherT, OtherArgs...>::mdspan_type>)
  KOKKOS_INLINE_FUNCTION View(
      const View<LabellOther, OtherT, OtherArgs...>& other,
      std::enable_if_t<
          std::is_constructible_v<
              mdspan_type,
              typename View<LabellOther, OtherT, OtherArgs...>::mdspan_type>,
          void*> = nullptr)
  ...
  template <ConstExprLabel Labelll, class RT, class... RP, class Arg0,
            class... Args>
  KOKKOS_INLINE_FUNCTION View(const View<Labelll, RT, RP...>& src_view,
...
template <ConstExprLabel LabelLeft, class LT, class... LP,
          ConstExprLabel LabelRight, class RT, class... RP>
KOKKOS_INLINE_FUNCTION bool operator==(const View<LabelLeft, LT, LP...>& lhs,
                                       const View<LabelRight, RT, RP...>& rhs) {
  ...
  return std::is_same_v<typename lhs_traits::const_value_type,
         ...
         View<LabelLeft, LT, LP...>::rank() ==
             View<LabelRight, RT, RP...>::rank() &&
